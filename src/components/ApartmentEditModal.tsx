...
export const ApartmentEditModal: React.FC<ApartmentEditModalProps> = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-5xl max-h-[90vh] p-0 flex flex-col dialog-content-mobile">
        ...
        <ScrollableContainer className="flex-1 px-6 py-4 apartment-modal-scrollable" maxHeight="calc(90vh - 140px)">
          <Tabs defaultValue="main" className="w-full apartment-modal-tabs">
            <TabsList className="grid w-full grid-cols-3 mb-6">
              <TabsTrigger value="main" className="py-2">Основное</TabsTrigger>
              <TabsTrigger value="content" className="py-2">Контент</TabsTrigger>
              <TabsTrigger value="media" className="py-2">Медиа</TabsTrigger>
            </TabsList>

            <TabsContent value="main" className="space-y-6">
              {/* Основная информация */}
              <Card className="apartment-modal-card">
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <Label htmlFor="building_number">Номер корпуса</Label>
                      <Input
                        id="building_number"
                    ...
                    <div>
                      <Label htmlFor="housing_complex">ЖК (Жилой комплекс)</Label>
                      <Input
                        id="housing_complex"
              ...
              <Card className="apartment-modal-card">
                <CardHeader>
                  <CardTitle className="text-lg">Доступ и подключения</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <Label htmlFor="wifi_password">Wi-Fi пароль</Label>
                      <Input
                        id="wifi_password"
            ...
            <TabsContent value="content" className="space-y-6">
              ...
              <Card className="apartment-modal-card">
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      <Label htmlFor="manager_phone">Телефон</Label>
                      <Input
                        id="manager_phone"
              ...
              <Card className="apartment-modal-card">
                ...
                <CardContent className="space-y-6">
                  <div className="space-y-4">
                    <div>
                      <Label htmlFor="faq_checkin" className="text-base font-medium">
                        FAQ: Заселение
                      </Label>
                    ...
                    <div>
                      <Label htmlFor="faq_apartment" className="text-base font-medium">
                        FAQ: Апартаменты
                      </Label>
                      <p className="text-sm text-muted-foreground mb-2">
                        Формат: Вопрос: ... Ответ: ...
                    ...
                    <div>
                      <Label htmlFor="faq_area" className="text-base font-medium">
                        FAQ: Территория
                      </Label>
                      <p className="text-sm text-muted-foreground mb-2">
                        Формат: Вопрос: ... Ответ: ...
              ...
              {/* Яндекс.Карты */}
              <Card className="apartment-modal-card apartment-modal-map-section">
                <CardHeader>
                  <CardTitle className="text-lg">Карта</CardTitle>
                </CardHeader>
                <CardContent>
                  <div>
                    <Label htmlFor="map_embed_code" className="text-base font-medium">
        ...
        <div className="flex gap-3 p-6 apartment-modal-actions">
          <Button onClick={onSave} className="flex-1 btn-primary" size="lg">
